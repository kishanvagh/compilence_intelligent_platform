    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-950 px-4">
      <div className="max-w-md w-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded p-8 shadow-sm">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">Sign in to your enterprise account</p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <div>
            ...
            <input
              ...
              className={`w-full text-sm px-3 py-2 rounded border bg-slate-50 dark:bg-slate-800 dark:text-white focus:outline-none focus:ring-1 focus:ring-blue-500 ${
                errors.email ? 'border-red-500 border-opacity-100' : 'border-slate-200 dark:border-slate-800'
              }`}
          ...
          <div>
            ...
            <input
              ...
              className={`w-full text-sm px-3 py-2 rounded border bg-slate-50 dark:bg-slate-800 dark:text-white focus:outline-none focus:ring-1 focus:ring-blue-500 ${
                errors.password ? 'border-red-500 border-opacity-100' : 'border-slate-200 dark:border-slate-800'
              }`}
              placeholder="••••••••"
            />
            {errors.password && (
